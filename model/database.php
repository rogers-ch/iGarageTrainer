    ...
    function readWorkouts($user)
    {
        ...
        foreach ($results as $workout) {
            ...
            /*
             ...
             Array ( [workout_id] => 2 [Date] => June 15th, 2020 ) 1
             Array ( [workout_id] => 3 [Date] => June 15th, 2020 ) 1
             */
            ...
            for ($i = 1; $i <= 6; $i++) {
                ...
                $exerciseIds[$i-1] = $this->readWorkoutLine($workout['workout_id'], $i);
